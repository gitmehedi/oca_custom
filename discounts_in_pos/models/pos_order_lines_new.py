...
# ===============adding 'discount fixed' to invoice lines==========================================
                ...
                invoice_line.invoice_line_tax_id = [tax.id for tax in invoice_line.invoice_line_tax_id if tax.company_id.id == company_id]
                fiscal_position_id = line.order_id.fiscal_position_id
                if fiscal_position_id:
                    invoice_line.invoice_line_tax_id = fiscal_position_id.map_tax(invoice_line.invoice_line_tax_id)
                invoice_line.invoice_line_tax_id = [tax.id for tax in invoice_line.invoice_line_tax_id]
