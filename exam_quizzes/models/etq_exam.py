...
class EtqQuestion(models.Model):
    ...
    question_type = fields.Selection((('multi_choice', 'Multiple Choice'), ('fill_blank', 'Fill in the Blank')),
                                     default="multi_choice", string="Question Type")
    ...
    question_options_blank = fields.One2many('etq.question.optionblank', 'question_id',
