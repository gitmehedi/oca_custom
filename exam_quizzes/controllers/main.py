...
class MyController(http.Controller):
    ...
    def take_exam_token(self, exam_slug, token):
        ...
        if exam_result.state == "complete":
            ...
            return http.request.render('exam_quizzes.exam_question_page', {'exam': exam, 'questions': questions, 'token': token})
	...
	for field_name, field_value in kwargs.items():
        ...
        return request.render('exam_quizzes.exam_results', {'exam_result':exam_result, 'question_count': question_count, 'correct_count': correct_count,'percent':percent})